            ...
            <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg">
                <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-300">Nombre</th>
                        <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-300">Apellido</th>
                ...
                <tbody>
                    @foreach($empleados as $empleado)
                        <tr class="border-t border-gray-300 dark:border-gray-700">
                            ...
                            <td class="px-4 py-2 text-sm text-gray-800 dark:text-gray-200">{{ $empleado->personas->nombre }}</td>
                            <td class="px-4 py-2 text-sm text-gray-800 dark:text-gray-200">{{ $empleado->persona->apellido }}</td>
