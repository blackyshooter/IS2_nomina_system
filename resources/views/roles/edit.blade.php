    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 p-6 shadow-md rounded-lg">
            <form action="{{ route('roles.update', $rol) }}" method="POST">
                ...
                <div class="mb-6">
                    <label class="block text-gray-700 dark:text-gray-300">Nombre del Rol</label>
                    <input type="text" name="nombre" value="{{ $rol->nombre }}" class="w-full mt-1 rounded-md" required>
                </div>
